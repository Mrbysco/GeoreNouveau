...
public enum LinkedGeOre implements StringRepresentable {
	...
	ANCIENT_DEBRIS("ancient_debris", () -> Blocks.NETHERITE_BLOCK, () -> GeOreRegistry.ANCIENT_DEBRIS_GEORE.getBudding().get(),
	...
	URANINITE("uraninite", () -> GeOreRegistry.URANINITE_GEORE.getBlock().get(), () -> GeOreRegistry.URANINITE_GEORE.getBudding().get(),
	...
	BLACK_QUARTZ("black_quartz", () -> GeOreRegistry.BLACK_QUARTZ_GEORE.getBlock().get(), () -> GeOreRegistry.BLACK_QUARTZ_GEORE.getBudding().get(),
	...
	MONAZITE("monazite", () -> GeOreRegistry.MONAZITE_GEORE.getBlock().get(), () -> GeOreRegistry.MONAZITE_GEORE.getBudding().get(),
	...
	ALUMINUM("aluminum", () -> GeOreRegistry.ALUMINUM_GEORE.getBlock().get(), () -> GeOreRegistry.ALUMINUM_GEORE.getBudding().get(),
	...
	LEAD("lead", () -> GeOreRegistry.LEAD_GEORE.getBlock().get(), () -> GeOreRegistry.LEAD_GEORE.getBudding().get(),
			() -> GeOreRegistry.LEAD_GEORE.getCluster().get(), () -> GeOreRegistry.LEAD_GEORE.getShard().get(), CompatRegistry.LEAD_GEORE_GOLEM_CHARM::get),
	NICKEL("nickel", () -> GeOreRegistry.NICKEL_GEORE.getBlock().get(), () -> GeOreRegistry.NICKEL_GEORE.getBudding().get(),
	...
	OSMIUM("osmium", () -> GeOreRegistry.OSMIUM_GEORE.getBlock().get(), () -> GeOreRegistry.OSMIUM_GEORE.getBudding().get(),
	...
	PLATINUM("platinum", () -> GeOreRegistry.PLATINUM_GEORE.getBlock().get(), () -> GeOreRegistry.PLATINUM_GEORE.getBudding().get(),
	...
	SILVER("silver", () -> GeOreRegistry.SILVER_GEORE.getBlock().get(), () -> GeOreRegistry.SILVER_GEORE.getBudding().get(),
	...
	TIN("tin", () -> GeOreRegistry.TIN_GEORE.getBlock().get(), () -> GeOreRegistry.TIN_GEORE.getBudding().get(),
			() -> GeOreRegistry.TIN_GEORE.getCluster().get(), () -> GeOreRegistry.TIN_GEORE.getShard().get(), CompatRegistry.TIN_GEORE_GOLEM_CHARM::get),
	TUNGSTEN("tungsten", () -> GeOreRegistry.TUNGSTEN_GEORE.getBlock().get(), () -> GeOreRegistry.TUNGSTEN_GEORE.getBudding().get(),
	...
	URANIUM("uranium", () -> GeOreRegistry.URANIUM_GEORE.getBlock().get(), () -> GeOreRegistry.URANIUM_GEORE.getBudding().get(),
	...
	ALLTHEMODIUM("allthemodium", getOptionalBlock(new ResourceLocation("allthemodium", "allthemodium_block"), GeOreRegistry.ALLTHEMODIUM_GEORE), () -> GeOreRegistry.ALLTHEMODIUM_GEORE.getBudding().get(),
	...
	VIBRANIUM("vibranium", getOptionalBlock(new ResourceLocation("allthemodium", "vibranium_block"), GeOreRegistry.VIBRANIUM_GEORE), () -> GeOreRegistry.VIBRANIUM_GEORE.getBudding().get(),
	...
	UNOBTAINIUM("unobtainium", getOptionalBlock(new ResourceLocation("allthemodium", "unobtainium_block"), GeOreRegistry.UNOBTAINIUM_GEORE), () -> GeOreRegistry.UNOBTAINIUM_GEORE.getBudding().get(),
	...
	private final ResourceLocation DEFAULT_TEXTURE = new ResourceLocation(ArsNouveau.MODID, "textures/entity/amethyst_golem.png");
	...
	LinkedGeOre(String name, Supplier<Block> blockSupplier, Supplier<Block> buddingSupplier, Supplier<Block> clusterSupplier,
		...
		this.textureLocation = new ResourceLocation(GeOreNouveau.MOD_ID, "textures/entity/" + name + "_golem.png");
	}
